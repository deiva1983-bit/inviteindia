...
class AjaxFileuploader {
	 ...
	 * @return string
	 */
	public function showFileUploader($uploaderId,$Tslogo) {
		if (in_array($uploaderId, $this->uploaderIdArray)) {
			...
			return '
						...
						<iframe name="iframe" src="imageupload.php?logoid='.$Tslogo.'" height="100px" width="350" style="display:block" scrolling="no" frameborder="0"> </iframe>
					 ';
		}
	}
}
