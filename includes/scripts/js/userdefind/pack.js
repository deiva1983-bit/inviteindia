...
$("#submitpay").click(function(){
	...
	var bname = $("#billing_name"), baddr = $("#billing_address"), bcity = $("#billing_city"), bstate = $("#billing_state"), bzip = $("#billing_zip"), bcountry = $("#billing_country"), allFields = $([]).add(bname).add(baddr).add(bcity).add(bstate).add(bzip).add(bcountry),tips = $(".validateTips");
	var bValid = true;
