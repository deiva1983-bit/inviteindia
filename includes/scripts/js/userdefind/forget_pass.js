$(document).ready(function(){
	...
	$('#signup-win').hide();
	$('#activate-signin-label').hide();
	
	$("#activate-signup").click(function(){
	$('#forget_pass_box').hide();
	$("#validateTipsLogin").hide();
	$('#signin-win').hide();
	$('#fp-win').hide();
	$('#signup-win').show();
	$('#activate-signup-label').hide();
	$('#activate-signin-label').show();
	});

	$("#activate-signin").click(function(){
	$('#forget_pass_box').hide();
	$("#validateTipsLogin").hide();
	$('#signin-win').show();
	$('#fp-win').show();
	$('#signup-win').hide();
	$('#activate-signup-label').show();
	$('#activate-signin-label').hide();
	});

	
	$("#trigger_fp").click(function(){
	var fp_email_txt = $("#txt_email_fp"),allFields_L = $([]).add(fp_email_txt),tips = $("#validateTipsLogin"),bValid = true;
	...
	if (bValid) {
				...
				tips.html(loadimg);
					...
					if(res == "invalid") {
						updateTips("We don't have a record of this mail Id. please register your account.", tips);
					} else {
						updateTips_sucess("We shared your account details; please check your mail.", tips);
						}
					false;
				});
				}
