...
$("#submitpay").click(function(){
	...
	var wed_list = $("#wedding_inv_lists"), own_dom = $("#own_domain_name"), contact_name = $("#own_contact_name"), contact_no = $("#own_contact_no"), bname = $("#billing_name"), baddr = $("#billing_address"), bcity = $("#billing_city"), bstate = $("#billing_state"), bzip = $("#billing_zip"), bcountry = $("#billing_country"), allFields_L = $([]).add(wed_list).add(own_dom), tips = $("#validateTipsPay");
    var bValid = true;
