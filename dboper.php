...
if($qry_req == 'thmedt' and $qry_do == "select" and $qry_wed_id != "" and $qry_theme_id != "" and $qry_might == "net")
{
...
else if($qry_req == 'thmedt' and $qry_do == "select" and $qry_birth_id != "" and $qry_theme_id != "" and $qry_might == "net")
{
...
elseif($qry_req == 'thmcrt' and ($qry_do == "cre0myli" or $qry_do == "demo") and  $qry_theme_id != "" and $qry_might == "net")
{
	$_SESSION['selected_themeid'] = $qry_theme_id;
	if($second_arr == '1') {// Wedding themes
		$_SESSION['gnav_personal_info']='0';
		$_SESSION['gnav_general_info']='0';
		$_SESSION['gnav_ceremony_info']='0';
		$_SESSION['gnav_reception_info']='0';
		unset($_SESSION['grooms_name']); unset($_SESSION['grooms_dob']);
		unset($_SESSION['brides_name']); unset($_SESSION['brides_dob']);
		unset($_SESSION['wed_url_engine']); unset($_SESSION['wed_invite_title']);
		...
		unset($_SESSION['ceremony_lng']); $_SESSION['ceremony_map_sts'] = '0';
		unset($_SESSION['ceremony_postcode']); $_SESSION['marriage_status'] = '0';
		...
		unset($_SESSION['reception_status']); unset($_SESSION['marriage_status']);
