...
if($doit == "man") {
	...
	if($prod_hidd == 'addp'){
		$service_short_desc=addslashes(trim($_REQUEST['service_short_desc']));
		$service_long_desc=addslashes(trim($_REQUEST['service_long_desc']));
		// insert pdts
		if($action == 'A') {
...
$content_template = "$vendors_tpl_path/business-supplier-add-desc.tpl"; 
