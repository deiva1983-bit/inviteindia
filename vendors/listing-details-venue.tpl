						...
						<div class="details-media-bx">
							...
							<div class="featured-lists">
								<ul class="navbar">
									...
									{if $tpl_head_count neq ''}<li><a href="#upto" class="scroll nav-link"><i class="la la-users"></i>{$tpl_head_count}</a></li>{/if}
									{if $tpl_room_count neq ''}<li><a href="#upto" class="scroll nav-link"><i class="la la-bed"></i>{$tpl_room_count}</a></li>{/if}
									{if $tpl_established neq ''}<li><a href="#upto" class="scroll nav-link"><i class="la la-diamond"></i>{$tpl_established}</a></li>{/if}
