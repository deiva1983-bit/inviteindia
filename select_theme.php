...
$user_log_id= trim($_SESSION['sess_user_id']);
	...
	{	$content_template = 'default/mrg_account/select_theme.tpl';
		...
		foreach($selectalbum_access as $key=>$field)
					...
					$nav_links = "<div class='demo-links-action'><a href='$submit_page&theme_id=$themeid&might=net'><span class='ping-color'>Select me</span></a> | <a href='$demourl' target='_blank'><span class='ping-color'>Demo theme</span></a></div>";
					$dbtitle=$themename.'&nbsp;';
					...
					$commdetails.="<div class='demo-links'>
									<div class='demo-links-title'><h4 class='sub_head'>$themename</h4></div>
									<div class='view view-seventh'>
										<a class='vlightbox1' href='templates/default/mrg_template/$themeurl/$demoimg' title='$titletag'>
											<img src='templates/default/mrg_template/$themeurl/$demoimg' id='$srcid' class='img-thumbnail image-size-cont' />
													<div class='mask'><h2>Wedding tips</h2>
													<p>$tips</p>
												</div>
										</a>
									</div>
...
// Classic Themes - But we dont have Own BG image options
	...
	{		$content_template = 'default/mrg_account/select_theme.tpl';
		...
		foreach($selectalbum_access as $key=>$field)
					...
					if($invite_type == 2) {
					$classic_commdetails.="<div class='demo-links'>
					<div class='demo-links-title'><h4 class='sub_head'>$themename</h4></div>
					<div class='view view-seventh'>
					...
					<div class='demo-links-title'><h4 class='sub_head'>$themename</h4></div>
					<div class='view view-seventh'>
					<a class='vlightbox1' href='templates/default/mrg_template/$themeurl/$demoimg' title='$titletag'><img alt='' src='templates/default/mrg_template/$themeurl/$demoimg'  id='$srcid' class='img-thumbnail image-size-cont' />
						<div class='mask'><h2>Wedding tips</h2>
						<p>$tips</p>
						</div>
					</a>
...
// Classic Themes - But we have Own BG image options
	...
	{		$content_template = 'default/mrg_account/select_theme.tpl';
		...
		foreach($selectalbum_access as $key=>$field)
					...
					if($invite_type == 2) {
					$classic_commdetails_bg.="<div class='demo-links'>
					<div class='demo-links-title'><h4 class='sub_head'>$themename</h4></div>
					<div class='view view-seventh'>
					<a class='vlightbox1' href='templates/default/birth_template/$themeurl/$demoimg' title='$titletag'><img alt='' src='templates/default/birth_template/$themeurl/$demoimg' id='$srcid' class='img-thumbnail image-size-cont' />
						<div class='mask'><h2>Events</h2>
