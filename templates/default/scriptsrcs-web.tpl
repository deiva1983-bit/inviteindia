...
{elseif $currentpage_js eq 'theme_select1'}
	<link rel="stylesheet" href="{$static_domain_path_css}/base/chocolat.css" type="text/css" media="screen">
	<link rel="stylesheet" href="{$static_domain_path_css}/userstyle-theme-selection.css" type="text/css" media="screen">
...
{elseif $currentpage_js eq 'theme_select'}
	<link rel="stylesheet" href="{$static_domain_path_css}/leftmenu.css" type="text/css" media="screen">
	<link rel="stylesheet" href="{$static_domain_path_css}/base/chocolat.css" type="text/css" media="screen">
	<link rel="stylesheet" href="{$static_domain_path_css}/userstyle-theme-selection.css" type="text/css" media="screen">
	<link rel="stylesheet" href="{$static_domain_path_js}/userdefind/slideshow/visuallightbox.css" type="text/css" media="screen">
	<script src="{$static_domain_path_js}/userdefind/slideshow/visuallightbox.js"></script>
	<script src="{$static_domain_path_js}/userdefind/slideshow/vlbdata1.js"></script>
...
{elseif $currentpage_js eq 'web_create_latest'}
	...
	<link rel="stylesheet" href="{$static_domain_path_css}/website-create.css" type="text/css" media="screen">
...
{elseif $currentpage_js eq 'main_page_tips'}
	<link rel="stylesheet" href="{$static_domain_path_css}/home_page_tips.css" type="text/css" media="screen">
	<script src='includes/scripts/userdefind/wedding-tips.js'></script>
