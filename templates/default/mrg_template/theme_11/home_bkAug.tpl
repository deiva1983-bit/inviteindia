...
<input type="hidden" name="theme_gift_id" id="theme_gift_id" value="1" class="inputval" />
            ...
            <div class="wedding_invitation_parallax">
                <div class="about_bottom_bg">
                    <div class="container text-center">
                        <h3 class="animated fadeIn visible" data-animation="fadeIn" data-animation-delay="100">{$tpl_event_title}</h3>
	...
	<article class="gallery_outer" id="photo_gallery" style="height: 800px !important;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
	 ...
	 <article class="lovestory_parallax" id="lovestory">
			...
			<div id="blessing_tables" {if !$tpl_default_signup} style='display: none;' {/if} >
                        <h3 class="animated fadeIn visible" data-animation="fadeIn" data-animation-delay="100">{$tpl_bless_title}</h3>
				...
				<div class="col-md-12 animated fadeIn visible" data-animation="fadeIn" data-animation-delay="200">
					...
					<h3 class="text-center animated fadeIn visible" data-animation="fadeIn" data-animation-delay="100">Add my blessings</h3>
