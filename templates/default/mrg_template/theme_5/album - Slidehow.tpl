...
<div id="container">
      <div id="choice-4" class="clearfix">
		<div id="content" class="index" data-pjax-container="" style="opacity: 1; display: block; background: rgba(54,50,54,0.8);">
			<div id="photos">
				<h1>Photos</h1>    
					...
					<div id="galleria" class="">
							...
							<div class="galleria-stage">
								<div class="galleria-info">
									<div class="galleria-info-text">
										<div class="galleria-info-title" style="display: inline;">sdsdsd</div>
										<div class="galleria-info-description" style="display: inline;">aaaaa</div>
									</div>
								</div>
						...
						<div class="galleria-bar">
							...
							<div class="galleria-thumbnails-container galleria-carousel">
								...
								<div class="galleria-thumbnails" style="overflow: hidden; position: relative; width: 632px; height: 33px; left: -172px; transition: none;">
							
										{$glb_selectphoto_access}
