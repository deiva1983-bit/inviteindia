...
<link href="imageblur/style.css" media="screen" rel="stylesheet" type="text/css" />
<script src="imageblur/background-blur.min.js"></script>
{literal}
<style>
...
.wsite-background-own {background-repeat: no-repeat !important;background-position: 50% 0 !important;background-size: auto !important;background-color: transparent !important;background: inherit;}
...
<div id="total-wrapper">
        ...
        var imgurl= {/literal}'{$glb_site_url}/images/classic_bg/{$classic_bg_image}.jpg'{literal};
                $('.avatar-holder').backgroundBlur({
                //imageURL : 'http://localhost/public_html/templates/default/mrg_template/theme_8/theme_33_demo.jpg?id=2',
                //imageURL : 'http://localhost:8081/public_html_stage/templates/default/mrg_template/theme_8/theme_33_demo.jpg?id=2',
                imageURL : imgurl,
                // First Format
                blurAmount : 50,
        ...
        <div class="avatar-holder top-background wsite-background-own wsite-custom-background" data-speed="4" data-type="background" style="background-image: url(&quot;images/classic_bg/{$classic_bg_image}.jpg&quot;);">
        {else}
                        ...
                        <div class="container header-align-outer">
                                <div class="header-align-mid about">
                                        <div class="header-align-inner">
                                                ...
                                                <span id="wsite-title">
                                                <span id="about_bride_name">{$glb_male_name}</span>
                                                ...
                                                {if $glb_master_id neq '7427'} <span id="about_message"><p>Thank you for visiting our wedding website! We hope you find it helpful, <br />and we're excited to share this journey with you.</p></span> {/if}
                                                </div>
                                ...
                                <div class="nav-container">
                                        <ul class='wsite-menu-default'>
                                                ...
                                                {/if}
                                                {if $glb_master_id eq '6790'}
                                                <li><a href="{$glb_page_url}?page=317" title="" class="about">Places to Visit</a></li>
                                                {/if}
                                        </ul>
                                </div>
                        </div><!-- end container -->
