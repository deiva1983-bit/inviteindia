...
<table border="0" align="center" width="100%">
                        <tr><td width="4.3.1%"><div class="article-left">&nbsp;</div></td>
                        <td width="91.6%">
{/if}
                        ...
                        </div>{if $glb_is_mobile neq 1}</td>
                        <td width="4%"><div class="article-right"><!-- <img src="{$glb_img_urls}images/lady.png" alt=" " />--></div></td></tr>
                        </table>{/if}
