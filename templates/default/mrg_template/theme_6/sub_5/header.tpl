...
<link rel="stylesheet" type="text/css" href="{$glb_img_urls}sub_5/style.css" />
<link href="{$glb_img_urls}style_{$glb_lang_id}.css" media="screen" rel="stylesheet"/>
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_5/majorcss.css' />
...
<!-- header  
                <header><h1 id="headmsg">{if $home_title eq ''}Welcome{else}{$home_title}{/if}</h1> -->
                <header>
                        <nav>
                                <ul id="menu" {if $glb_total_alb_records neq 0} style='padding-left: 212px;' {elseif $glb_animate_cover neq 0} style='padding-left: 200px;' {else} style='padding-left: 260px;' {/if}>
                                                ...
                                                <li style="background:none;"><a href="{$glb_page_url}" title="">Cover Design</a></li>
                                                {/if}
