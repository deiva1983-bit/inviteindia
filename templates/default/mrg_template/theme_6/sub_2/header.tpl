...
<div class="pag_lcon" id="left-top">
                ...
                <header>
                        <nav>
                                <ul id="menu">
                                                ...
                                                {/if}
                                                <li {if $c_page_status eq '' || $c_page_status eq 'h'} id="menu_active" {/if}><a href="{$glb_page_url}?status=h" title="Home">{$glb_wed_card_title_home}</a></li>
