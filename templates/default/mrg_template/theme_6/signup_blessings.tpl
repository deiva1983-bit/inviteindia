<!-- content --><h2 style="text-align: center;"><span id='pageheddings'>{$tpl_guestbook_title}</span></h2>
		<section id="content">
			...
			<tr>
				<td style="width:50%;">
					<div id="wish-form">
						...
						<input type="text" class="input" name="guest_name" id="guest_name" style="width: 400px;"/>
					</div>
					<div id="wish-form">
						<label>{$tpl_signup_email} *</label>
						<input type="text" class="input" name="guest_email" id="guest_email" style="width: 400px;"/>
					</div>
					<div id="wish-form">
						<label>{$tpl_signup_loc}</label>
						<input type="text" class="input" name="guest_loc" id="guest_loc" style="width: 400px;"/>
					</div>
			
					<div id="wish-form">
						<label>{$tpl_signup_wish}</label>
						<textarea name="guest_msg" id="guest_msg" style="width: 400px; height:150px;" class="input"></textarea>
					</div>
				</td>

				<td style="width:50%; vertical-align: top;">
					<div id="wish-form">
					<h2>{$tpl_signup_samplewishes}</h2>
					</div>
					<div class="numbers_box" style=" float: left;   height: 266px;   overflow: scroll;  width: 100%;">
			...
			<tr><td style="width: 120px;" valign="top">{$tpl_signup_giftitems}</td><td style="width: 500px;">
			<div style="overflow:auto; height:150px; border:#CCCCCC solid 1px; padding-bottom:5px;"> {$album_giftdetails}</div>
			</td></tr>
			</table>
			<div>&nbsp;</div>
			<div>
