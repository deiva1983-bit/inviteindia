...
<link rel="stylesheet" type="text/css" href="{$glb_img_urls}sub_7/style.css" />
<link href="{$glb_img_urls}style_{$glb_lang_id}.css" media="screen" rel="stylesheet"/>
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_7/majorcss.css' />
		...
		<header>
			<nav>
				<ul id="menu">
						...
						<li style="background:none;"><a href="{$glb_page_url}" class='about'>Cover Design</a></li>
						{/if}
						<li {if $c_page_status eq ''} id="menu_active" {/if}><a href="{$glb_page_url}?status=h" class='about'>{$glb_wed_card_title_home}</a></li>
