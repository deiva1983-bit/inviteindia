...
<link rel="stylesheet" type="text/css" href="{$glb_img_urls}sub_8/style.css" />
<link href="{$glb_img_urls}style_{$glb_lang_id}.css" media="screen" rel="stylesheet"/>
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_8/majorcss.css' />
...
<!-- header  -->
		<header>
			<nav>
				<ul id="menu" {if $glb_total_alb_records neq 0} style='padding-left: 179px;' {elseif $glb_animate_cover neq 0} style='padding-left: 166px;' {else} style='padding-left: 246px;' {/if}>
						...
						<li><a href="{$glb_page_url}" title="">Cover Design</a>
						{/if}
