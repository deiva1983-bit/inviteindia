...
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_6/majorcss.css' />
...
<div class="extra pag_con" id="right-bottom">
	<div class="main center_footer">
		<header>
			<nav>
				<ul id="menu" {if $glb_total_alb_records neq 0} style='padding-left: 212px;' {elseif $glb_animate_cover neq 0} style='padding-left: 200px;' {else} style='padding-left: 221px;' {/if}>
