...
-->
<!-- content --><h2 style="text-align: center;"><span id='pageheddings'>{$tpl_album_title}</span></h2><br />
		<section id="content">
			<div id="content" class="index alb_slideshow" data-pjax-container="" style="display: block;">
			<div id="photos" style="opacity: 1;  background: rgba(54,50,54,0.8); padding: 12px; width: 521px;">
