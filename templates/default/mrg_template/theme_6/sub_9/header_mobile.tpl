...
<link rel="stylesheet" type="text/css" href="{$glb_img_urls}sub_9/style.css" />
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_9/mobile.css' />
<link href="{$glb_img_urls}style_{$glb_lang_id}.css" media="screen" rel="stylesheet"/>
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_9/majorcss.css' />
