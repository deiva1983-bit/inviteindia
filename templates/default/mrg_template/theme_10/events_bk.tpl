...
<div class="art-content-layout-row">
    ...
    <h1 id='headmsg'>{$tpl_event_title}</h1>
    </div>
</div>
	...
	<div style="padding:30px">
		<div>
			...
			<div>
				{if $smt_rec_title neq ''}<h2><span id='eventsubhead'>{$smt_rec_title}</span></h2>
				{else}<h2><span id='eventsubhead'>Reception</span></h2>
				{/if}
			...
			<div class="group">
				{if $smt_wed_title neq ''}<h2><span id='eventsubhead'>{$smt_wed_title}</span></h2>
				{else}
				<h2><span id='eventsubhead'>Marriage</span></h2>
				{/if}
