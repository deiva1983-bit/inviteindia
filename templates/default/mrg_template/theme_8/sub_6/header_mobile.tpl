...
<link href="{$glb_img_urls}sub_6/style.css" media="screen" rel="stylesheet"/>
<link href="{$glb_img_urls}sub_6/mobile_style.css" media="screen" rel="stylesheet"/>
...
{literal}
<script>
    new BackgroundImage("{$glb_img_urls}sub_6/bg.jpg", "{$glb_img_urls}sub_6/bg.jpg", {horizontal: "center", vertical: "center"}).loadBackground();
  </script>
  {/literal} -->
...
{else}
  <div id="backdrop"><div style="opacity: 1; background-image: url(&quot;{$glb_img_urls}sub_6/bg.jpg&quot;); background-position: center center;" class="background backdrop-thumbnail"></div><div style="background-position: center center; opacity: 1; background-image: url(&quot;{$glb_img_urls}sub_6/bg.jpg&quot;);" class="background backdrop-full"></div></div>
  {/if}
