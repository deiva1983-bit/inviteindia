...
<link href="{$glb_img_urls}sub_2/style.css" media="screen" rel="stylesheet"/>
...
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_2/majorcss.css' title='wsite-theme-css' />
        ...
        <div id="dl-menu" class="dl-menuwrapper">
                <button class="dl-trigger">Open Menu</button>
                        <ul class="dl-menu">
                                ...
                                {if $glb_theme_owner_id eq '13558'}
                                <li><a href="{$glb_page_url}?page=289">Promises Made</a></li>
                                {/if}
      ...
      <div id="choice-1" class="clearfix index"  style="width: 460px;">
                <div id="left-side" style="opacity: 1; display: block;">
                        <div>
                                <h1 id="about_name"><span id="about_bride_name">{$glb_male_name}</span> <span id="about_names_link">&amp;</span> <span id="about_groom_name">{$glb_female_name}</span></h1>
                                <h2 id="about_date">{$glb_marriage_date_title}</h2>
                                <div id="about_message" style="display:block">{if $glb_theme_owner_id neq '13558'}<p>{$tpl_home_heading}</p>{/if}
                        </div>
                </div>
  </div>
  ...
  <div id="content" class="index " data-pjax-container="" style="opacity: 1; display: block; padding: 15px; background: none; width: 460px;" >   
        <div id="wedding-party" class="clearfix ">
                <div class="people" style='padding: 1px;'>
                        ...
                        {if $glb_theme_owner_id eq '18901'}
                        <li><a href="{$glb_page_url}?page=406" class="selected">Abhipriya</a></li>
                        {/if}                                                   
...
{literal}
<script>
    new BackgroundImage("{$glb_img_urls}sub_2/IMG_64472.jpg", "{$glb_img_urls}sub_2/IMG_64472.jpg", {horizontal: "center", vertical: "center"}).loadBackground();
  </script>
  {/literal} -->
...
{else}
 <div id="backdrop"><div style="opacity: 1; background-image: url(&quot;{$glb_img_urls}sub_2/IMG_64472.jpg&quot;); background-position: center center;" class="background backdrop-thumbnail"></div><div style="background-position: center center; opacity: 1; background-image: url(&quot;{$glb_img_urls}sub_2/IMG_64472.jpg&quot;);" class="background backdrop-full"></div></div>
{/if}