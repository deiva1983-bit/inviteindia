...
<link href="{$glb_img_urls}sub_3/style.css" media="screen" rel="stylesheet"/>
<link href="{$glb_img_urls}sub_3/mobile_style.css" media="screen" rel="stylesheet"/>
...
<link rel='stylesheet' type='text/css' href='{$glb_img_urls}sub_3/majorcss.css' title='wsite-theme-css' />
...
{literal}
<script>
    new BackgroundImage("{$glb_img_urls}sub_3/IMG_64472.jpg", "{$glb_img_urls}sub_3/IMG_64472.jpg", {horizontal: "center", vertical: "center"}).loadBackground();
  </script>
  {/literal} -->
...
{else}
  <div id="backdrop"><div style="opacity: 1; background-image: url(&quot;{$glb_img_urls}sub_3/IMG_64472.jpg&quot;); background-position: center center;" class="background backdrop-thumbnail"></div><div style="background-position: center center; opacity: 1; background-image: url(&quot;{$glb_img_urls}sub_3/IMG_64472.jpg&quot;);" class="background backdrop-full"></div></div>
{/if}
