                        ...
                        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                                <div class="container">
                                        ...
                                        <a class="navbar-brand">
                                                <img src="{$glb_img_urls}../common_mobile/ring-hearts-icon.png" alt="" style="height: 49px;">
                                        </a>
                                        </div>
                                        ...
                                        <ul class="nav navbar-nav">
                                                ...
                                                {if $glb_total_alb_records neq 0}<li><a href="{$glb_page_url}?status=3">{$glb_wed_card_title_album}</a></li>{/if}
                                                {if $glb_animate_cover neq '0'}<li><a href="{$glb_page_url}?status=c">Wedding Cover</a></li>{/if}
                                                {$ownpage_linksmobile}
                                        </ul>
                                        </div>
                                        <!-- /.navbar-collapse -->
