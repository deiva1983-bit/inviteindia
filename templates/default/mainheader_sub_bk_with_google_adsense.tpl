		...
		<div class="container banner-layer">
			...
			<div class="w3ls_banner_info">
					<div class="agileits_w3layouts_banner_info">
						<h1 class="home-head"><strong>Perfect wedding websites</strong></h1>
						<h1 class="sub-head">For your Special Day!</h1>
						<h2>Highly secure wedding website, Fully customizable theme, Wedding event, Guest book management, RSVP etc,.</h2>
