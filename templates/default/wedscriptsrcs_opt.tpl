...
{if $isMobile neq 1}
<script src="{$glb_img_urls}vendor/jquery/jquery.min.js"></script>
{/if}
	...
	<script type="text/javascript" src="{$glb_site_url}includes/scripts/home/jquery.superfish.js"></script>
	<script type="text/javascript" src="{$glb_site_url}includes/scripts/home/jquery.jcarousel.pack.js"></script>
	<script type="text/javascript" src="{$glb_site_url}includes/scripts/home/jquery.easing.js"></script>
	<script type="text/javascript" src="{$glb_site_url}includes/scripts/home/jquery.scripts.js"></script>
	...
	<script type="text/javascript" src="{$glb_site_url}includes/scripts/userdefind/classicwedding.js"></script>
