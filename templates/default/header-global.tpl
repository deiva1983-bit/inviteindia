{*
 * Global Header Template (Smarty)
 *
 * File: templates/default/header-global.tpl
 * Description: Unified header with responsive navigation, modal authentication, and global styling
 *
 * Usage in index.tpl:
...
<head>
    ...
    <link href="{$static_domain_path_css}/base/font-awesome.css" rel="stylesheet" type="text/css" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="signupPassword" placeholder="Create a password (minimum 6 characters)">
                ...
                <div class="form-group">
                    <label>
                        ...
                        <a href="{$glb_site_url}/terms.php" target="_blank">Terms & Conditions</a>
                    </label>
...
(function() {
    ...
    const GlobalHeader = {
        ...
        handleLogin: function() {
            ...
            if (!this.validateLogin(username, password, errorDiv)) return;

            const url = this.siteUrl + '/ajax_login.php';
        ...
        validateLogin: function(username, password, errorDiv) {
        ...
        handleSignup: function() {
            ...
            if (!this.validateSignup(name, email, username, password, agreeTerms, errorDiv)) return;

            const url = this.siteUrl + '/ajax_signup.php';
        ...
        validateSignup: function(name, email, username, password, agreeTerms, errorDiv) {
            if (!name) {
