...
<script src="includes/scripts/ljs/jquery-1.6.js"></script>
<script src="includes/scripts/ljs/cufon-yui.js"></script>
<script src="includes/scripts/ljs/cufon-replace.js"></script>
<script src="includes/scripts/ljs/Forum_400.font.js"></script>
<script src="includes/scripts/ljs/quick{$glb_minify_js}.js"></script>
...
<script src="{$glb_site_url}includes/scripts/maxheight{$glb_minify_js}.js"></script>
...
<!-- Start Local only  -->
<!-- <script src="{$glb_site_url}includes/scripts/jquery-1.10.2.js"></script>
<script src="{$glb_site_url}includes/scripts/jquery-ui.js"></script> -->
<!-- End Local only  -->
...
<script src='includes/scripts/userdefind/registration.js'></script>
{elseif $currentpage_js eq 'main_page'}
        ...
        <script src="includes/scripts/home/jquery.slidorion.min.js"></script>
        <script src='includes/scripts/userdefind/hmain{$glb_minify_js}.js'></script>
{elseif $currentpage_js eq 'home_page'}
        <script src='includes/scripts/userdefind/registration.js'></script>
        <script src='includes/scripts/userdefind/forget_pass.js'></script>
{elseif $currentpage_js eq 'myprofile_profile_control'}
        <script src='includes/scripts/jquery.validate.js'></script>
        <script src="includes/scripts/ui/jquery.ui.tabs.js"></script>
        <script src='includes/scripts/userdefind/myprofile_profile_control.js'></script>
        <script src='includes/scripts/userdefind/uploader.js'></script>
{elseif $currentpage_js eq 'my_sms'}
        <script src="includes/scripts/ui/jquery.ui.widget.js"></script>
        <script src="includes/scripts/ui/jquery.ui.button.js"></script>
        <script src="includes/scripts/ui/jquery.ui.tabs.js"></script>
        <script src="includes/scripts/ui/jquery.effects.core.js"></script>
        <script src="includes/scripts/ui/jquery.ui.position.js"></script>
        <script src="includes/scripts/ui/jquery.ui.autocomplete.js"></script>
        <script src='includes/scripts/userdefind/sms_plain_control.js'></script>
{elseif $currentpage_js eq 'mobileactivate_page'}
        <script src="includes/scripts/ui/jquery.ui.widget.js"></script>
        <script src="includes/scripts/ui/jquery.ui.button.js"></script>
        <!-- <script src='includes/scripts/userdefind/jquery.blockUI.js'></script> -->
        <script src='includes/scripts/userdefind/mobile_activate.js'></script>
{elseif $currentpage_js eq 'interviewhome'}
        <script src='{$glb_site_url}includes/scripts/userdefind/interviewhome.js'></script>
        <script src="{$glb_site_url}includes/scripts/userdefind/login.js"></script>
{elseif $currentpage_js eq 'viewanswer'}
        <script src="{$glb_site_url}editor/ckeditor.js"></script>
        <script src="{$glb_site_url}editor/edt/sample.js"></script>
        <link rel="stylesheet" href="{$glb_site_url}editor/edt/sample.css" type="text/css" media="screen" />
        <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.widget.js"></script>
        <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.button.js"></script>
        <script src='{$glb_site_url}includes/scripts/userdefind/interviewhome.js'></script>
        <script src="{$glb_site_url}includes/scripts/userdefind/login.js"></script>
{elseif $currentpage_js eq 'signup'}
        ...
        <script src="{$glb_site_url}includes/scripts/userdefind/signup.js"></script>
        <script src="{$glb_site_url}includes/scripts/userdefind/login.js"></script>
{elseif $currentpage_js eq 'theme_select'}
        <script src='includes/scripts/jquery.validate.js'></script>
        <link href="includes/css/userdefind/wedding.css" rel="stylesheet" type="text/css" />
        <script src="includes/scripts/ui/jquery.effects.datetime.js"></script>
        <script src="includes/scripts/ui/jquery-ui-sliderAccess.js"></script>
        <!--
        <script src="includes/scripts/dt/jquery-1.7.2.min.js"></script>
        <script src='includes/scripts/dt/jquery-ui.min.js'></script>
...
{elseif $currentpage_js eq 'birth_create'}
        <script src='includes/scripts/jquery.validate.js'></script>
        <script src='includes/scripts/userdefind/mrg_account/theme_options_birth.js'></script>
...
{elseif $currentpage_js eq 'payment'}
        <script src='includes/scripts/userdefind/payment.js'></script>
{elseif $currentpage_js eq 'wedd_ani'}
        <script src='includes/scripts/userdefind/mrg_account/add_cover.js'></script>
{elseif $currentpage_js eq 'wedhome'}
        <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.widget.js"></script>
        <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.button.js"></script>
        <script src='{$glb_site_url}includes/scripts/jquery.validate.js'></script>
        <script src="{$glb_site_url}includes/scripts/external/jquery.bgiframe-2.1.1.js"></script>
        <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.position.js"></script>
        <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.dialog.js"></script>
        <script src="{$glb_site_url}includes/scripts/userdefind/wedding.js"></script>
        <script src='{$glb_site_url}includes/scripts/userdefind/interviewhome.js'></script>
...
{elseif $currentpage_js eq 'wed_share_sms'}
         <script src='includes/scripts/jquery.validate.js'></script>
         <script src='includes/scripts/userdefind/mrg_account/smsshare.js'></script>
         ...
         <script src='{$glb_site_url}includes/scripts/userdefind/pack.js'></script>
         {elseif $currentpage_js eq 'vendors_home'}
         <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.widget.js"></script>
         <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.button.js"></script>
         <script src='{$glb_site_url}includes/scripts/userdefind/vendors.js'></script>
         {elseif $currentpage_js eq 'vendors_login'}
          <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.widget.js"></script>
         <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.button.js"></script>
         <script src='{$glb_site_url}includes/scripts/userdefind/vendors/login.js'></script>
         {elseif $currentpage_js eq 'vendors_pdts'}
          <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.widget.js"></script>
         <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.button.js"></script>
         <script src='{$glb_site_url}includes/scripts/userdefind/validat_all{$glb_minify_js}.js'></script>
         <script src='{$glb_site_url}includes/scripts/userdefind/vendors/ven_suppliers.js'></script>
         {elseif $currentpage_js eq 'surl'}
          <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.widget.js"></script>
         <script src="{$glb_site_url}includes/scripts/ui/jquery.ui.button.js"></script>
         <script src="{$glb_site_url}includes/scripts/userdefind/surl.js"></script>
          {elseif $currentpage_js eq 'owndomain'}
          <script src='includes/scripts/userdefind/validat_all{$glb_minify_js}.js'></script>
         <script src='{$glb_site_url}includes/scripts/userdefind/owndom.js'></script>
        ...
        <!-- <script src="http://www.inviteindia.com/templates/default/mrg_template/theme_11/js_plugin/bootstrap.js"></script> -->
        {/if}