<nav class="menu menu--sebastian">
	<ul id="m_nav_list" class="m_nav menu__list">
		...
		{if $smarty.session.sess_user_id neq '' }
			...
			<li class="m_nav_item {if $topnav_select eq 'wtips'}active{/if}" id="moble_nav_item_9"> <a href="blog/" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Blogs">Blogs</span></a></li>
		{else}
			...
			<li class="m_nav_item {if $topnav_select eq 'wtips'}active{/if}" id="moble_nav_item_7"> <a href="blog/" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Blogs">Blogs</span></a></li>
		{/if}
	</ul>
</nav>