<nav class="menu menu--sebastian">
	<ul id="m_nav_list" class="m_nav menu__list">
		...
		<li class="dropdown m_nav_item" id="moble_nav_item_6">
			...
			<li class="m_nav_item {if $topnav_select eq 'vendors'}active{/if}" id="moble_nav_item_10"> <a href="{$glb_site_url}vendors/index.php" class="link link-kumya"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="Vendors">Vendors</span></a></li>
			</ul>
		</li>
		{else}
