		...
		<div class="contact-main w3agile">
			...
			<div class="col-md-9">
				...
				{if $alert_msg neq ''}<div class="alert green_succ" role='alert'>{$alert_msg}</div>{/if}
					...
					<div><p><input type="checkbox" id="wedding_status" name="wedding_status" value="1" 
					...
					<div class="field"><span><em><font color="red">Example - Wedding party.</font></em></span>&nbsp;<span><em><font color="red">If you don't want title, please ignore this field.</font></em></span></div>
