	...
	<tr>
		...
		<td class="normal" style="border-left:1px solid #FFFFFF;" height="321px;">
			...
			<div class="normal">
					...
					<h3>Support Us: Pay with Paypal </h3>
...
<!-- <form class="paypal" action="payments.php" method="post" id="paypal_form"> -->
  <table class="layout-grid" cellspacing="0" cellpadding="0" style="width:945px;">
	...
	<p><h3>HDFC Account Details:</h3></p>

				<p>
				<div class="field">
				<label style="width:200px;">Account Number:</label> 
				<label style="width:200px; color:#404141;">0795 1610 0450 15</label>				  
				</div>
				</p><br /><br />				
				<p>
				<div class="field">
				<label style="width:200px;">Account Type:</label> 
				<label style="width:200px; color:#404141;">Saving</label> 
				</div>
				</p><br /><br />
				<p>
				<div class="field">
				<label style="width:200px;">Account holder name:</label> 
				<label style="width:200px; color:#404141;">V. Deivasigamani</label> 
				</div>
				</p><br /><br />
				<p>
				<div class="field">
				<label style="width:200px;">IFSC Code:</label> 
				<label style="width:200px; color:#404141;">HDFC0000795</label> 
				</div>
				</p><br /><br />
				
				<p>
				<div class="field">
				<label style="width:200px;">MICR Code:</label> 
				<label style="width:200px; color:#404141;">600240026</label> 
				</div>
				</p><br /><br />
				
				<p>
				<div class="field">
				<label style="width:200px;">Bank Name:</label> 
				<label style="width:200px; color:#404141;">HDFC Bank,</label> 
				</div>
				</p><br /><br />
				<p>
				<div class="field">
				<label style="width:200px;">Branch Name:</label> 
				<label style="width:200px; color:#404141;">CHENNAI - PERUNGUDI,</label> 
				</div>
				</p><br /><br />
				<span><font color="red">If you donate via netbanking, kindly send one mail- inviteindia.feedback@gmail.com</font></span>
				  
				<p><h3>Issues with payment: </h3></p>
				<p>			
				 ...
				 <span><font color="red">Currently inviteinida.com support only PayPal. if you have any issues with PayPal transactions please fill below form and submit, our support team will contact you immediately.</font></span>
