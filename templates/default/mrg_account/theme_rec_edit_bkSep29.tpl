		...
		<div class="contact-main w3agile">
			...
			<div class="col-md-9">
				...
				{if $alert_msg neq ''}<div class="alert green_succ" role='alert'>{$alert_msg}</div>{/if}
					...
					<div><p><input type="checkbox" id="reception_status" name="reception_status" value="1" 
					...
					{/if}
					/><label class='lab_black_color'>&nbsp; I want to add reception details.</label></p></div>
					...
					<div class="field"><span><em><font color="red">Example - Reception</font></em></span>&nbsp;<span><em><font color="red">If you don't want title, please ignore this field.</font></em></span></div>
					</div>
					</p>
