<nav class="menu menu--sebastian">
	<ul id="m_nav_list" class="m_nav menu__list">
		...
		{if $smarty.session.sess_user_id neq '' }
			...
			<!--
			<li class="dropdown m_nav_item {if $topnav_select eq 'wtips'}active{/if}" id="moble_nav_item_8">
			...
			<li class="m_nav_item" id="moble_nav_item_9"> <a href="wedding-tips-for-brides" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Wedding tips for brides">Wedding tips for brides</span></a></li>

			<li class="m_nav_item" id="moble_nav_item_10"> <a href="wedding-tips-for-grooms" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Wedding tips for grooms">Wedding tips for grooms</span></a></li>

			<li class="m_nav_item" id="moble_nav_item_11"> <a href="preparing-guest-list-for-wedding" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Tips for guest list preparation">Tips for guest list preparation</span></a></li>
			-->
		...
		{else}
			...
			<!--
			<li class="dropdown m_nav_item {if $topnav_select eq 'wtips'}active{/if}" id="moble_nav_item_6">
			<a href="#" class="dropdown-toggle link link--kumya" data-toggle="dropdown"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i><span data-letters="Wedding tips">Wedding tips</span></a>

			<ul class="dropdown-menu agile_short_dropdown">
			<li class="m_nav_item" id="moble_nav_item_7"> <a href="wedding-tips-for-brides" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Wedding tips for brides">Wedding tips for brides</span></a></li>

			<li class="m_nav_item" id="moble_nav_item_8"> <a href="wedding-tips-for-grooms" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Wedding tips for grooms">Wedding tips for grooms</span></a></li>

			<li class="m_nav_item" id="moble_nav_item_9"> <a href="preparing-guest-list-for-wedding" class="link link--kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Tips for guest list preparation">Tips for guest list preparation</span></a></li>
			-->
