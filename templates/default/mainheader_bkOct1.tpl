...
<meta property="og:url" content="http://www.inviteindia.com/wedding-website-templates" />
					...
					<div id="m_nav_container" class="m_nav wthree_bg">
						<nav class="menu menu--sebastian">
							<ul id="m_nav_list" class="m_nav menu__list">
								...
								<li class="m_nav_item {if $topnav_select eq 'themes'}active{/if}" id="m_nav_item_2"> <a href="wedding-website-templates" class="link link--kumya"><i class="fa fa-wpforms" aria-hidden="true"></i><span data-letters="Themes">Themes</span></a></li>
								...
								<li class="m_nav_item {if $topnav_select eq 'owndomain'}active{/if}" id="moble_nav_item_5"> <a href="create-your-own-domain-for-your-wedding-website" class="link link--kumya"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="My domain">My domain</span></a></li>
							</ul>
						</nav>
					</div>
					{else}
			...
			<ul class="slides">
				<li>
					<div class="agileits_w3layouts_banner_info">
						...
						<h1 class="sub-head">Online wedding website</h1>
						<h2>Create a free wedding website with your complete wedding plan. You can add your own wedding songs, wedding gifts, wedding photography, wedding dresses, pre-wedding plans, wedding story, Your first meet, own domain and much more.</h2>
							...
							<div class="col-md-4 agileits_banner_bottom_grid_left">
								...
								<h4 class="sub_head_min"><a href='wedding-website-registration' class='sub_head up-margin badge badge-primary'>Login</a></h4>
								{/if}
							</div>
							...
							<div class="col-md-4 agileits_banner_bottom_grid_left">
								...
								<h4 class="sub_head_min"><a href='sample-wedding-websites' class='sub_head up-margin badge badge-primary'>Sample websites</a></h4>
							</div>
							<div class="col-md-4 agileits_banner_bottom_grid_left">
								<div class="agileinfo_banner_bottom_grid_l_grid home-quick-links">
									<i class="fa fa-wpforms" aria-hidden="true"></i>
								</div>
								<h4 class="sub_head_min"><a href='wedding-website-templates' class='sub_head up-margin badge badge-primary'>Website themes</a></h4>
							</div>
							<div class="clearfix"> </div>
							</div>
