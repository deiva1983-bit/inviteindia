<nav class="menu menu--sebastian">
	<ul id="m_nav_list" class="m_nav menu__list">
		...
		<li class="m_nav_item {if $topnav_select eq 'owndomain'}active{/if}" id="moble_nav_item_4"><a href="{$glb_site_url}buy-domain.php" class="link link-kumya"><i class="fa fa-id-badge" aria-hidden="true"></i><span data-letters="Buy domain">Buy domain</span></a></li>
		...
		<li class="m_nav_item {if $topnav_select eq 'wtips'}active{/if}" id="moble_nav_item_7"><a href="{$glb_site_url}blogs.php" class="link link-kumya"><i class="fa fa-pencil" aria-hidden="true"></i><span data-letters="Blog">Blog</span></a></li>
		...
		<!-- <li class="dropdown m_nav_item" id="moble_nav_item_7">
			...
			<li class="m_nav_item {if $topnav_select eq 'wgift'}active{/if}" id="moble_nav_item_8"> <a href="{$glb_site_url}wedding-gift-for-couples" class="link link-kumya"><i class="fa fa-gift" aria-hidden="true"></i><span data-letters="Wedding Gift">Wedding </span></a></li>
			<li class="m_nav_item {if $topnav_select eq 'vendors'}active{/if}" id="moble_nav_item_9"> <a href="{$glb_site_url}vendors/vendors-search.php" class="link link-kumya"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="Vendors">Vendors</span></a></li>
			</ul>
		</li> -->
		{else}
