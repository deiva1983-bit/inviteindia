                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12 p-b30">
						<div class="details-media-bx">
							...
							<div class="featured-lists">
								<ul class="navbar">
									<li><a href="#" class="scroll nav-link"><i class="la la-money"></i> for Photographers hire</a></li>
									{if $delivery_time_tpl neq ''}<li><a href="#" class="scroll nav-link"><i class="la la-users"></i>{$delivery_time_tpl}</a></li>{/if}
									{if $established_tpl neq ''}<li><a href="#" class="scroll nav-link"><i class="la la-bed"></i>{$established_tpl}</a></li>{/if}
						...
						<!-- Pricing & Costs End -->
						<h5 class="details-title">Pricing & Costs</h5>
						<div class="location-details">
							<div class="row">
								{if $price_candid_photography_status_tpl eq '1'}
								<div class="col-lg-6 m-b20">
									<h5 class="title">Price candid photography:</h5>
									<p>{$price_candid_photography_tpl}</p>
								</div>
								{/if}
								{if $price_cinematography_status_tpl eq '1'}
								<div class="col-lg-6 m-b20">
									<h5 class="title">Price cinematography:</h5>
									<p>{$price_cinematography_tpl}</p>
								</div>
								{/if}
								{if $price_studio_photography_status_tpl eq '1'}
								<div class="col-lg-6 m-b20">
									<h5 class="title">Price studio photography:</h5>
									<p>{$price_studio_photography_tpl}</p>
								</div>
								{/if}
								{if $price_pre_wedding_shoot_status_tpl eq '1'}
								<div class="col-lg-6 m-b20">
									<h5 class="title">Price pre wedding shoot:</h5>
									<p>{$price_pre_wedding_shoot_tpl}</p>
								</div>
								{/if}

								{if $price_photo_package_status_tpl eq '1'}
								<div class="col-lg-6 m-b20">
									<h5 class="title">Price photo package:</h5>
									<p>{$price_photo_package_tpl}</p>
								</div>
								{/if}
								{if $price_video_package_status_tpl eq '1'}
								<div class="col-lg-6 m-b20">
									<h5 class="title">Price video package:</h5>
									<p>{$price_video_package_tpl}</p>
								</div>
								{/if}
