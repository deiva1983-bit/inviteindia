	...
	<div class="container">
			<div class="w3ls_banner_bottom_grids">
				...
				<div class="col-md-12">
					...
					<div><span id='citylists'><select id='city_drop' name='city_id' class="inputval" >
				{$tpl_sele_city}</select></span></div>
				...
				<div class="col-md-12">
					...
					<div><span id='arealists'><select id='cat_id' name='cat_id' class="inputval">{$tpl_sele_pdt}</select></span>
					</div>
				</div>
			...
			<div class="w3ls_banner_bottom_grids"> <h3 class="w3layouts_head"><span>Vendors</span></h3>
