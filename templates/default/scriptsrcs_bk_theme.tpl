...
<script src="{$glb_site_url}includes/scripts/maxheight.js" type="text/javascript"></script>
...
{elseif $currentpage_js eq 'main_page'}	
	<link type="text/css" href="includes/css/slidorion.css" rel="stylesheet" />
	<script type="text/javascript" src="includes/scripts/home/jquery.slidorion.min.js"></script>
	<script type='text/javascript' src='includes/scripts/userdefind/hmain.js'></script>
{elseif $currentpage_js eq 'home_page'}
	<script type='text/javascript' src='includes/scripts/userdefind/validat_all.js'></script>
	<script type='text/javascript' src='includes/scripts/userdefind/registration.js'></script> 
