...
{if $currentpage_js eq 'vendors_pdts'}
	...
	<script src="{$glb_vendors_lib_path}../includes/scripts/imagecrop/croppie.min.js"></script>
	<script src="{$glb_vendors_lib_path}../includes/scripts/imagecrop/vendor_reg.js"></script>
	<link rel="stylesheet" href="{$glb_vendors_lib_path}../includes/scripts/imagecrop/croppie.css" />
