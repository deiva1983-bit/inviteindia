...
$chkqry= "SELECT murl.ownpage_links, murl.mrg_main_user_id, murl.mrg_url_sts_auto_id, murl.mrg_theme_id, mthm.mrg_theme_url, mthm.mrg_theme_sub_sts, mthm.mrg_theme_sub_url, mthm.mrg_theme_catid, usrlog.usrlog_plan FROM mrg_url_status murl, mrg_mas_theme mthm, tbl_user_login usrlog WHERE murl.mrg_page_url ='$page_url' and murl.mrg_status = '1' and mthm.mrg_theme_auto_id = murl.mrg_theme_id and mthm.mrg_theme_status='1' and usrlog.usrlog_id = murl.mrg_main_user_id";
