...
<?php
	...
	$workingKey='806103789F1FF0DA9741C4313F130F03';		//Working Key should be provided here.
	...
	echo "<center>";
    $data='';
	$myfile = fopen("newfilecc1.txt", "a") or die("Unable to open file!");
...
*/
	...
	$content_template = 'default/about_trans.tpl';
	$smarty->assign('header', $smarty->fetch('default/header.tpl') );
