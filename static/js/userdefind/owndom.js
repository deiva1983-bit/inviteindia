...
$("#submitpay").click(function(){
	...
	var wed_list = $("#wedding_inv_lists"), own_dom = $("#own_domain_name"), contact_name = $("#own_contact_name"), contact_no = $("#own_contact_no"), bname = $("#billing_name"), baddr = $("#billing_address"), bcity = $("#billing_city"), bstate = $("#billing_state"), bzip = $("#billing_zip"), bcountry = $("#billing_country"), btel = $("#billing_tel"), allFields_L = $([]).add(wed_list).add(own_dom), tips = $("#validateTipsPay");
    var bValid = true;
    ...
    bValid = bValid && checkEmpty(bname,"Billing name",tips);
    bValid = bValid && checkEmpty(baddr,"Billing address",tips);
    bValid = bValid && checkEmpty(bcity,"Billing city",tips);
    bValid = bValid && checkEmpty(bstate,"Billing state",tips);
    bValid = bValid && checkEmpty(bzip,"Billing zip",tips);
    bValid = bValid && checkEmpty(bcountry,"Billing country",tips);
    bValid = bValid && checkEmpty(btel,"Mobile number", tips);
