...
$cancel_url = 'http://www.inviteindia.com/paycancel.php';
$notify_url = 'http://www.inviteindia.com/payments.php';
	...
	if (!$fp) {
		...
		while (!feof($fp)) {
			...
			if (strcmp($res, "VERIFIED") == 0) {
				...
				$sqry = "INSERT INTO `payments` (pay_autoid, pay_userid, pay_txnid, pay_amount, pay_status, pay_planid, pay_createdtime, 	pay_type) VALUES ( null,
                '".$data['userlog_id']."' ,
                '".$data['txn_id']."' ,
                '".$data['payment_amount']."' ,
                '".$data['payment_status']."' ,
